...
//
//    @Mock
//    private PedidosResponseMapper descricaoPedidoResponseMapper;
//
//    @Mock
//    private DescricaoPedidoResponseMapper descricaoPedidoResponseMapper;
//
//    @Mock
...
//
//        verify(descricaoPedidoResponseMapper).apply(eq(pagedResponse));
//    }
//
//    @Test
...
//
//        verify(descricaoPedidoResponseMapper).apply(pedido);
...
//        service.descricaoNecessidade(id);
//
//        verifyNoInteractions(descricaoPedidoResponseMapper);
//    }
//
//    @Test
...
//        when(descricaoPedidoResponseMapper.apply(any())).thenCallRealMethod();
//
//        final DescricaoPedidoResponse resultado = service.atualizarPedido(idNecessidade, request, userPrincipal);
//
//        verify(repository).findByIdAndTipoPedido(any(), any());
//        verify(repository).save(pedidoEntityArgumentCaptor.capture());
//        verify(descricaoPedidoResponseMapper).apply(pedidoEntityArgumentCaptor.getValue());
//
...
//
//        verifyNoInteractions(repository, descricaoPedidoResponseMapper);
//    }
//
//    @Test(expected = ApiException.class)
...
//
//        verify(descricaoPedidoResponseMapper).apply(pedidoEntityPage);
